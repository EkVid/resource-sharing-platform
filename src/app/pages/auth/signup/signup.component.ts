      ...
      <div class="auth-content">
        ...
        <mat-card class="auth-card" [class.dark-theme]="isDarkTheme">
          ...
          <mat-card-header>
            ...
            <mat-card-subtitle>Create your account to access and share resources</mat-card-subtitle>
          </mat-card-header>
          ...
          <mat-card-content>
            ...
            <form [formGroup]="signupForm" (ngSubmit)="onSignup()">
              ...
              <mat-form-field appearance="outline" class="full-width" [class.dark-theme]="isDarkTheme">
                <mat-label [style.color]="isDarkTheme ? 'white' : 'black'">Confirm Password</mat-label>
                <input matInput [type]="hideConfirmPassword ? 'password' : 'text'" formControlName="confirmPassword"
                       [style.border-color]="isDarkTheme ? 'white' : 'black'"
                       [style.color]="isDarkTheme ? 'white' : 'black'">
                <mat-icon matSuffix (click)="hideConfirmPassword = !hideConfirmPassword" [style.color]="isDarkTheme ? 'white' : 'rgba(0, 0, 0, 0.54)'">
